        ...
        <div className="topBar w-full flex flex-col shadow-md pb-10">
            ...
            <div className='flex w-full flex-row items-center justify-between'>
                ...
                <div className="relative">
                    <input style={{ background: "linear-gradient(#29A9E3, #00A34C)" }} type="search" name="q" className="py-2 placeholder-white text-sm text-white pl-10 w-[325px] outline-none h-[56px] rounded-[11px]" placeholder="Type here to search something..." autoComplete="off" />
                ...
                <div className="relative transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-200 cursor-pointer">
                    <button style={{ background: "linear-gradient(#29A9E3, #00A34C)" }} className='w-[231px] h-[56px] rounded-[11px] text-white cursor-pointer'>Make a new deposit</button>
                    <span className='absolute inset-y-0 left-0 flex items-center pl-2'>
