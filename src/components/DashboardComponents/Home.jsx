    ...
    <>
      <div className="main w-[1000px] lg:w-full flex flex-col justify-center items-center">
        ...
        <div className='w-[900px] mt-[30px] flex flex-row lg:gap-[57px] justify-center'>
          <div className="w-[320px] h-[168px] flex flex-col justify-center gap-1 items-center p-5 rounded-md" style={{ background: "linear-gradient(to right, #29A9E3, #272C36)" }}>
            <img src={c1} alt="" />
            <h3 className='font-bold text-white text-4xl'>63,356 $</h3>
            <p className='text-white'>Earnings</p>
          </div>
        ...
        <div className='w-[900px] mt-[30px] flex flex-row justify-center items-center'>
          <div className="w-[270px] h-[168px] flex flex-col justify-center gap-1 items-center p-5 rounded-md" style={{ background: "linear-gradient(to right, #29A9E3, #272C36)" }}>
            <img src={c4} alt="" />
            <h3 className='font-bold text-white text-4xl'>63,356 $</h3>
            <p className='text-white'>Earnings</p>
          </div>
        ...
        <div className='w-[900px] h-[465px] mt-[30px] flex flex-row gap-[3px] rounded-md justify-center items-center' style={{ background: "linear-gradient(to right, #29A9E3, #272C36)" }}>
        ...
        <div className='w-[900px] h-[465px] mt-[30px] flex flex-col gap-10 rounded-md justify-center items-center' style={{ background: "linear-gradient(to right, #29A9E3, #272C36)" }}>
          <img src={box} alt="" />
          ...
          <button className='w-[258px] h-[81px] rounded-md text-3xl font-bold text-white' style={{ background: "linear-gradient(to right, #115A56, #001F1B)" }}>Refer</button>
        </div>
        ...
        <div className='w-[900px] h-[120px] mb-[10px] flex flex-row gap-[30px] rounded-md justify-start items-center' style={{ background: "linear-gradient(to right, #29A9E3, #272C36)" }}>
        ...
        <div className='w-[900px] h-[120px]  flex flex-row gap-[30px] rounded-md justify-start items-center' style={{ background: "linear-gradient(to right, #29A9E3, #272C36)" }}>
